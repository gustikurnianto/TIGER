...
import { getDatabase, set, remove, update, ref, push, child, get, onValue, onChildAdded, onChildRemoved } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-database.js";
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyBj8B824RP1_YnOrFMQjVtUCZgTjKYuVvc",
    authDomain: "petsoft-20e0b.firebaseapp.com",
    databaseURL: "https://petsoft-20e0b-default-rtdb.firebaseio.com",
    projectId: "petsoft-20e0b",
    storageBucket: "petsoft-20e0b.appspot.com",
    messagingSenderId: "152246955222",
    appId: "1:152246955222:web:9133fa1247253df22fad77"
  };
  ...
  //-----------------------------------------------------------------------------------//
        ...
        var exthighlightz = document.getElementById('exthighlightz');
        var myimg = document.getElementById('myimg');
        var myimgz = document.getElementById('myimgz');
        var myimgzz = document.getElementById('myimgzz');
        ...
        var databaseunamez = document.getElementById('databaseunamez').value;
        var databasereport = document.getElementById('databasereport').value;
        var databasedisablelogin = document.getElementById('databasedisablelogin').value;
        var databasedisablewa = document.getElementById('databasedisablewa').value;
        var databasedisablereservasi = document.getElementById('databasedisablereservasi').value;
        var databasethemez = document.getElementById('databasethemez').value;
        var databasesosmedz = document.getElementById('databasesosmedz').value;
        var databasefoto = document.getElementById('databasefoto').value;
        var databaseBGfoto = document.getElementById('databaseBGfoto').value;
        var databaseBGTheme = document.getElementById('databaseBGTheme').value;
        var databasehighlight = document.getElementById('databasehighlight').value;
        var databaseMenuDentist = document.getElementById('databaseMenuDentist').value;
        var databaseMenuscaling = document.getElementById('databaseMenuscaling').value;
        var databaseMenutambal = document.getElementById('databaseMenutambal').value;
        var databaseMenubedah = document.getElementById('databaseMenubedah').value;
        var databaseMenubehel = document.getElementById('databaseMenubehel').value;
        var databaseMenugitur = document.getElementById('databaseMenugitur').value;
        var databaseMenubleaching = document.getElementById('databaseMenubleaching').value;
        var databaseMenuveneer = document.getElementById('databaseMenuveneer').value;
        var databaseMenulainnya = document.getElementById('databaseMenulainnya').value;
        var databasepin = document.getElementById('databasepin').value;
        var databasejadwal = document.getElementById('databasejadwal').value;
        var databaselibur = document.getElementById('databaselibur').value;
        var databaseMenuDentist = document.getElementById('databaseMenuDentist').value;
        var databasereservasi = document.getElementById('databasereservasi').value;
        var databasenotif = document.getElementById('databasenotif').value;
        ...
        reader.onload = function (e) {
            ...
            $('#branding').css('background-image', 'url('+e.target.result +')');
            $('#logoprofile').css('background-image', 'url('+e.target.result +')');
        ...
        $("#upbtnzzhighlightz").click(function() {
            ...
            UploadTaskzz.on('state-changed', (snapshot)=>{
                ...
                if (barteksz.innerHTML == "upload 100%" ) {    
                    ...
                    $('#barteks3').css('background-size', '5%');
                    $('#barteks3').css('background-repeat', 'no-repeat');
                    $('#barteks3').css('background-position', '74% 50%');
                    $('#barteks3').css('width', '250px');
                    $('#barteks3').css('text-align', 'left');
                    $('#barteks3').css('padding-left', '64px');
                }
    ...
    //-----------------------------------------------------------------------------------//
        ...
        function postreservasiwhatsapp() {
            ...
            var blanter_whatsapp = walink + '?phone=' + phone + '&text=' + walink2 + '%0A%0A' + "-" + judulreservasi + "-" + '%0A%0A' +
                '*Nama Pemilik* : ' + jawabannamapasien + '%0A' +
                '*Alamat Pemilik* : ' + jawabanalamat + '%0A' +
                '*Nama dan Jenis Hewan* : ' + jawabantanggallahirz + '%0A' +
                '*Jenis Kelamin Hewan* : ' + jawabanjeniskelaminz + '%0A' +
                '*Umur Hewan* : ' + jawabanumur + '%0A' +
                '*Keluhan* : ' + jawabankeluhan + '%0A' +
                '*Riwayat Alergi* : ' + jawabanalergi + '%0A' +
                '*Tanggal Reservasi* : ' + jawabanjadwal + '%0A' +
                '*Waktu Reservasi* : ' + jawabanjamss + '%0A' +
                '*Dokter Hewan* : ' + jawabanjamssdokter + '%0A' +
        ...
        function postreservasi(reservasis) {
            ...
            set(ref(database, databasereservasi+"/Health/"+a+kodepin),{
                ImageKeluhan: name,
    ...
    //----------------------------------------------------------encrypt---------------------------------------------------//
        ...
        function encryptNamaPasien(){
            var jawabannamapasien = document.getElementById('jawabannamapasien').value;
            var encryptedNamaPasien = CryptoJS.AES.encrypt(jawabannamapasien, "Caredible");
            return encryptedNamaPasien.toString();
        }

        function encryptAlamat(){
            var jawabanalamat = document.getElementById('jawabanalamat').value;
            var encryptedAlamat = CryptoJS.AES.encrypt(jawabanalamat, "Caredible");
            return encryptedAlamat.toString();
        }

        function encryptJenisKelamin(){
            var jawabanjeniskelamin = document.getElementById('jawabanjeniskelamin').value;
            var encryptedJenisKelamin = CryptoJS.AES.encrypt(jawabanjeniskelamin, "Caredible");
            return encryptedJenisKelamin.toString();
        }

        function encryptTanggalLahir(){
            var jawabantanggallahir = document.getElementById('jawabantanggallahir').value;
            var encryptedTanggalLahir = CryptoJS.AES.encrypt(jawabantanggallahir, "Caredible");
            return encryptedTanggalLahir.toString();
        }

        function encryptUmur(){
            var jawabanumur = document.getElementById('jawabanumur').value;
            var encryptedUmur = CryptoJS.AES.encrypt(jawabanumur, "Caredible");
            return encryptedUmur.toString();
        }

        function encryptHp(){
            var jawabanhp = document.getElementById('jawabanhp').value;
            var encryptedHp = CryptoJS.AES.encrypt(jawabanhp, "Caredible");
            return encryptedHp.toString();
        }

        function encryptKeluhan(){
            var jawabankeluhan = document.getElementById('jawabankeluhan').value;
            var encryptedKeluhan = CryptoJS.AES.encrypt(jawabankeluhan, "Caredible");
            return encryptedKeluhan.toString();
        }

        function encryptAlergi(){
            var jawabanalergi = document.getElementById('jawabanalergi').value;
            var encryptedAlergi = CryptoJS.AES.encrypt(jawabanalergi, "Caredible");
            return encryptedAlergi.toString();
        }

        function encryptKodepin(){
            var kodepin = document.getElementById("kodepin").value;
            var encryptedKodepin = CryptoJS.AES.encrypt(kodepin, "Caredible");
    ...
    //----------------------------------------------------------encrypt---------------------------------------------------//
        ...
        window.onload = function() {
            setTimeout(function(){
                var ubahusernamekeep = document.getElementById('Lgnpcrd').value;
                var keepLoggedIncDbgst100395 = localStorage.getItem(ubahusernamekeep);   
                if (keepLoggedIncDbgst100395 == "yes") {
                    $('.themehome').prepend('<div id="loadingselesailogin" style="display:none"></div>');
                    setTimeout(function(){
                        $('#loadingselesailogin').show(function(){
                            setTimeout(function(){
                                getUsername();
                            }, 1000);
                        });
        ...
        function getUsername() {
            ...
            setTimeout(function(){
                ...
                let keepLoggedIncDbgst100395 = localStorage.getItem(ubahusernamekeep);
                ...
                if (keepLoggedIncDbgst100395 == "yes") {
                    ...
                    $('#brand').remove();
                    $('#kotakbrand').append('<div id="brandotomatis" style="display:">masuk</div>');
        ...
        $("#useRonLyIds").on("input",function(){
            var databaseunamez = document.getElementById('databaseunamez').value;
            get(child(ref(database), databaseunamez+"/Profile/")).then((snapshot)=>{
                if(snapshot.exists()){
                    var inputanpassword = snapshot.val().password;
                    var decryptedpassword = CryptoJS.AES.decrypt(inputanpassword, "Caredible");
                    ...
                    if(useRonLyIds == jawabanpassword){
        ...
        $("#enteredit").click(function() {
            ...
            get(child(ref(database), databaseunamez+"/Profile/")).then((snapshot)=>{
                if(snapshot.exists()){
                    ...
                    var decryptedemail = CryptoJS.AES.decrypt(inputanemail, "Caredible");
                    var jawabanemail = decryptedemail.toString(CryptoJS.enc.Utf8);
                    var emLeDId = document.getElementById('emLeDId').value;
                    var inputanpassword = snapshot.val().password;
                    var decryptedpassword = CryptoJS.AES.decrypt(inputanpassword, "Caredible");
                    var jawabanpassword = decryptedpassword.toString(CryptoJS.enc.Utf8);
                    var psswrDeDId = document.getElementById('psswrDeDId').value;
                    if(emLeDId == jawabanemail & psswrDeDId == jawabanpassword){
                        inputObserverz.disconnect();
                        login();
                        databaseunamezProfile();
                        databasereservasiHealth();
                        ...
                        $('#clock').fadeIn();
                        $('#clock').append('<span id="seconds">25</span>');
                        $('#enteredit').hide();
                        buttonreport();
        ...
        $("#entercekreservasi").click(function() {
            var inputcekreservasiss = document.getElementById('inputcekreservasiss').value;
            ...
            get(child(ref(database), databasereservasi+"/Health/"+inputcekreservasiss)).then((snapshot)=>{
                if(snapshot.exists()){
                    var inputannamapasien = snapshot.val().jawabannamapasien;
                    var decryptednamapasien = CryptoJS.AES.decrypt(inputannamapasien, "Caredible");
                    var inputanalamat = snapshot.val().jawabanalamat;
                    var decryptedalamat = CryptoJS.AES.decrypt(inputanalamat, "Caredible");
                    var inputanjeniskelamin = snapshot.val().jawabanjeniskelamin;
                    var decryptedjeniskelamin = CryptoJS.AES.decrypt(inputanjeniskelamin, "Caredible");
                    var inputantanggallahir = snapshot.val().jawabantanggallahir;
                    var decryptedtanggallahir = CryptoJS.AES.decrypt(inputantanggallahir, "Caredible");
                    var inputanhp = snapshot.val().jawabanhp;
                    var decryptedhp = CryptoJS.AES.decrypt(inputanhp, "Caredible");
                    var inputankeluhan = snapshot.val().jawabankeluhan;
                    var decryptedkeluhan = CryptoJS.AES.decrypt(inputankeluhan, "Caredible");
                    var inputanalergi = snapshot.val().jawabanalergi;
                    var decryptedalergi = CryptoJS.AES.decrypt(inputanalergi, "Caredible");
                    var inputankodepin = snapshot.val().kodepin;
                    var decryptedkodepin = CryptoJS.AES.decrypt(inputankodepin, "Caredible");
            ...
            get(child(ref(database), databasereservasi+"/Done/"+inputcekreservasiss)).then((snapshot)=>{
                if(snapshot.exists()){
                    var inputannamapasiendone = snapshot.val().jawabannamapasien;
                    var decryptednamapasiendone = CryptoJS.AES.decrypt(inputannamapasiendone, "Caredible");
                    var inputanalamatdone = snapshot.val().jawabanalamat;
                    var decryptedalamatdone = CryptoJS.AES.decrypt(inputanalamatdone, "Caredible");
                    var inputanjeniskelamindone = snapshot.val().jawabanjeniskelamin;
                    var decryptedjeniskelamindone = CryptoJS.AES.decrypt(inputanjeniskelamindone, "Caredible");
                    var inputantanggallahirdone = snapshot.val().jawabantanggallahir;
                    var decryptedtanggallahirdone = CryptoJS.AES.decrypt(inputantanggallahirdone, "Caredible");
                    var inputanhpdone = snapshot.val().jawabanhp;
                    var decryptedhpdone = CryptoJS.AES.decrypt(inputanhpdone, "Caredible");
                    var inputankeluhandone = snapshot.val().jawabankeluhan;
                    var decryptedkeluhandone = CryptoJS.AES.decrypt(inputankeluhandone, "Caredible");
                    var inputanalergidone = snapshot.val().jawabanalergi;
                    var decryptedalergidone = CryptoJS.AES.decrypt(inputanalergidone, "Caredible");
                    var inputankodepindone = snapshot.val().kodepinInfoDone;
                    var decryptedkodepindone = CryptoJS.AES.decrypt(inputankodepindone, "Caredible");
                    jawabannamapasien.value = decryptednamapasiendone.toString(CryptoJS.enc.Utf8);
                    jawabanalamat.value = decryptedalamatdone.toString(CryptoJS.enc.Utf8);
                    jawabanjeniskelamin.value = decryptedjeniskelamindone.toString(CryptoJS.enc.Utf8);
                    jawabanjeniskelaminz.value = decryptedjeniskelamindone.toString(CryptoJS.enc.Utf8);
                    jawabantanggallahir.value = decryptedtanggallahirdone.toString(CryptoJS.enc.Utf8);
                    jawabantanggallahirz.value = decryptedtanggallahirdone.toString(CryptoJS.enc.Utf8);
                    jawabanhp.value = decryptedhpdone.toString(CryptoJS.enc.Utf8);
                    kodepin.value = decryptedkodepindone.toString(CryptoJS.enc.Utf8);
                    kodepinbukti.value = decryptedkodepindone.toString(CryptoJS.enc.Utf8);
                    judulbukti.innerHTML = "hai "+decryptednamapasiendone.toString(CryptoJS.enc.Utf8)+",";
                };
        ...
        $('html').on('click','#batalreservasi',function() { 
            var myNamez = $(this).val();
            remove(ref(database, databasereservasi+myNamez));
            $("#batalreservasi").text('reservasi dibatalkan');
            $("#batalreservasi").css('background', 'red');
            $("#batalpinnich").trigger('click');
        });

        $('html').on('click','#batalpinnich',function() { 
            var myNamez = $(this).val();
            $("#"+myNamez).remove();
        });
        ...
        $("#entercekreservasi2").click(function() {
            ...
            var tanggallahirpasien = document.getElementById('tanggallahirpasien');
            ...
            get(child(ref(database), databasereservasi+"/Health/"+inputcekreservasiss)).then((snapshot)=>{
                if(snapshot.exists()){
                    var inputannamapasien = snapshot.val().jawabannamapasien;
                    var decryptednamapasien = CryptoJS.AES.decrypt(inputannamapasien, "Caredible");
                    var inputanjawabantanggallahir = snapshot.val().jawabantanggallahir;
                    var decryptedjawabantanggallahir = CryptoJS.AES.decrypt(inputanjawabantanggallahir, "Caredible");
                    var inputankodepin = snapshot.val().kodepin;
                    var decryptedkodepin = CryptoJS.AES.decrypt(inputankodepin, "Caredible");
                    namapasien.value = decryptednamapasien.toString(CryptoJS.enc.Utf8);
                    tanggallahirpasien.value = decryptedjawabantanggallahir.toString(CryptoJS.enc.Utf8);
                    jadwalpasien.value = snapshot.val().jawabanjadwal;
                    jampasien.value = snapshot.val().jawabanjam;
                    statuspasien.value = "status: Aktif/Baru";
                    waktukirimpasien.value = snapshot.val().waktu;
                    ...
                    $('#batalreservasi').val("/Health/"+snapshot.val().nomorreservasiz+decryptedkodepin.toString(CryptoJS.enc.Utf8));
                    $('#batalpinnich').val(snapshot.val().nomorreservasi+'pinnich'+'New');
                };
            ...
            get(child(ref(database), databasereservasi+"/Done/"+inputcekreservasiss)).then((snapshot)=>{
                if(snapshot.exists()){
                    ...
                    var inputankodepindone = snapshot.val().kodepinInfoDone;
                    var decryptedkodepindone = CryptoJS.AES.decrypt(inputankodepindone, "Caredible");
                    namapasien.value = decryptednamapasiendone.toString(CryptoJS.enc.Utf8);
                    tanggallahirpasien.value = decryptedtanggallahirdone.toString(CryptoJS.enc.Utf8);
                    jadwalpasien.value = snapshot.val().jawabanjadwal;
                    jampasien.value = snapshot.val().jawabanjam;
                    ...
                    $('#batalreservasi').val("/Done/"+snapshot.val().nomorreservasiz);
                    $('#batalpinnich').val(snapshot.val().nomorreservasiDone+'pinnich'+'Done');
                };
        ...
        $("#disablelogin").click(function() {
            var disablelogin = document.getElementById('disablelogin');
            var databaseuname = document.getElementById('databaseuname').value;
            var databasedisablelogin = document.getElementById('databasedisablelogin').value;
            const id = push(child(ref(database), databaseuname)).key;
            if (disablelogin.checked == true) {
                set(ref(database, databasedisablelogin+"DisableLogin"),{
                    disableloginbutton: "aktif"
                });
            } else {
                set(ref(database, databasedisablelogin+"DisableLogin"),{
                    disableloginbutton: "non aktif"
                });
            }
        });
        ...
        $('#logoutbutton').click(function(){
            $('#loadingselesailogin').remove();
            disableloginremove();
            $('.disableloginswitch').css('background-color', 'white');
            $('.disableloginswitch').css('color', 'black');
            $('.disableloginswitch').css('border', '1px solid transparent');
            $('.disableloginswitch').css('background-image', 'url("https://lh3.googleusercontent.com/mNATOLI6HS8DgwqD5jxra0yxIYLB-rwpaWLYulZZSwhrRp6UHiP2n_pBNfv_Un_rIAzhbYfzk6_8_2kJqJVcTg6Wo3QCZl0S3EMCq6tTyyvaxng7dmic3Jw4pXQ2lUxEzQ0kK5GD8w=w2400")');
            $('.disableloginswitch').css('box-shadow', 'none');
            $('.disableloginswitch').prop('disabled', true);
        ...
        function disableloginremove(){
            var databaseuname = document.getElementById('databaseuname').value;
            var databasedisablelogin = document.getElementById('databasedisablelogin').value;
            remove(ref(database, databasedisablelogin+"DisableLogin"));
        }
        ...
        $('#lupaspassword').click(function(){
            ...
            $('#lupaspassword').hide();
            $('#clock').hide();
            $('.keeploginswitch').hide();
            $('#psswrDeDId').hide();
            $('#edittools').text('Lupa Password?');
            $('#edittools').css('margin-top', '40px');
            $('#ownertools').css('margin-top', '10px');
            $('#ownertools').text('silahkan masukkan email yang anda tautkan');
            $("#emLeDId").attr("id", "emLeDIdLpaPsswrD").on( "click", function() {
                $("#emLeDIdLpaPsswrD").show();
            });
            $("#kotakeditprofil").append('<center><button id="entereditLpaPsswrD">OK</button></center>');
            $("#entereditLpaPsswrD").click(function() {
                get(child(ref(database), databaseunamez+"/Profile/")).then((snapshot)=>{
                    if(snapshot.exists()){
                        var inputanemail = snapshot.val().email;
                        var decryptedemail = CryptoJS.AES.decrypt(inputanemail, "Caredible");
                        var jawabanemail = decryptedemail.toString(CryptoJS.enc.Utf8);
                        var emLeDIdLpaPsswrD = document.getElementById('emLeDIdLpaPsswrD').value;
                        if(emLeDIdLpaPsswrD == jawabanemail){
                            $('#entereditLpaPsswrD').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHfYgmRXNM8KQnYOsNuTQG86eemaPxfE7zj_6_VDM7nzsQ8AofJaMzl78PNivIUBP4l68fGh-1f2d1n15FXTTXtmXwR9aso5j5kZWp94jZ_KiWdaOuw=w2400")');
                            $('#entereditLpaPsswrD').css('background-size', '25%');
                            $('#entereditLpaPsswrD').css('background-repeat', 'no-repeat');
                            $('#entereditLpaPsswrD').css('background-position', 'center');
                            $('#entereditLpaPsswrD').css('color', 'transparent');
                            $('#entereditLpaPsswrD').prop('disabled', true);
                            $("#emLeDIdLpaPsswrD").css('border', '2px solid green');
                            let code_val = Math.floor(Math.random()*1000000);
                            $.ajax({
                                method: 'POST',
                                url: 'https://formsubmit.co/ajax/'+jawabanemail,
                                dataType: 'json',
                                accepts: 'application/json',
                                data: {
                                    from: "Caredible",
                                    note: "jangan sebarkan kode verifikasi perubahan password ini, jika anda tidak merasa bahwa anda yang meminta perubahan password",
                                    verification_code: code_val,
                                    _template: "table",
                                    _subject: "Permintaan Perubahan Password - Caredible"
                                },
                                success: (data) => {
                                    $("#entereditLpaPsswrD").remove();
                                    $("#emLeDIdLpaPsswrD").css('border', 'none');
                                    $("#emLeDIdLpaPsswrD").attr('type', 'text');
                                    $("#emLeDIdLpaPsswrD").attr('placeholder', 'kode verifikasi..');
                                    $("#emLeDIdLpaPsswrD").val('');
                                    $('#edittools').text('Kode Verifikasi');
                                    $('#ownertools').text('kode verifikasi telah terkirim ke-email anda, silahkan cek email, kemudian klik "activate form" & tunggu kode verifikasi diterima di-email anda');
                                    $("#kotakeditprofil").append('<center><button id="entereditVrfy">OK</button></center>');    
                                    var i = 1; 
                                    const verify = document.getElementById('emLeDIdLpaPsswrD');
                                    $('#entereditVrfy').click(function(){
                                        if (i >= 4) {
                                        ...
                                        if (verify.value == code_val) { 
                                            $('#entereditVrfy').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHfYgmRXNM8KQnYOsNuTQG86eemaPxfE7zj_6_VDM7nzsQ8AofJaMzl78PNivIUBP4l68fGh-1f2d1n15FXTTXtmXwR9aso5j5kZWp94jZ_KiWdaOuw=w2400")');
                                            $('#entereditVrfy').css('background-size', '25%');
                                            $('#entereditVrfy').css('background-repeat', 'no-repeat');
                                            $('#entereditVrfy').css('background-position', 'center');
                                            $('#entereditVrfy').css('color', 'transparent');
                                            $('#entereditVrfy').prop('disabled', true);
                                            $('#emLeDIdLpaPsswrD').css('border', '2px solid green');
                                            $('#emLeDIdLpaPsswrD').attr('readonly', true);
                                            $('#emLeDIdLpaPsswrD').css('color', 'transparent');
                                            $('#emLeDIdLpaPsswrD').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHecSdkRRvo0Z3kFO6fVK6Ex-ZvHMVziKMeIRfsLW9zhwIrDeswdXIEbnnfEGFcWVpyRSXIUi7NtZFjeXFB1xMuxjXDRwLf6wC2siOxzz2dPT5cxbMo=w2400")');
                                            $('#emLeDIdLpaPsswrD').css('background-size', '9%');
                                            $('#emLeDIdLpaPsswrD').css('background-repeat', 'no-repeat');
                                            $('#emLeDIdLpaPsswrD').css('background-position', 'center');
                                            setTimeout(function(){
                                                $('#emLeDIdLpaPsswrD').css('color', 'transparent');
                                                $('#emLeDIdLpaPsswrD').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHdBYJ4kHgMi0Bb8wW458zLoejreottNp2bnsPJFJikfQLjkSzdll_N6n4F6uV4ncAKhp9gt2_-SasGZcoFoTACtIUgiA2rt7b816aMmDvRQ7XToYIM=w2400")');
                                                $('#emLeDIdLpaPsswrD').css('background-size', '25%');
                                                $('#emLeDIdLpaPsswrD').css('background-repeat', 'no-repeat');
                                                $('#emLeDIdLpaPsswrD').css('background-position', 'center');
                                            }, 3000);   
                                            setTimeout(function(){
                                                $('#edittools').text('Password Baru');
                                                $('#ownertools').text('silahkan masukkan password baru anda, disarankan kombinasi huruf besar, huruf kecil, simbol, dan angka');
                                                $('#emLeDIdLpaPsswrD').attr('readonly', false);
                                                $("#emLeDIdLpaPsswrD").css('border', 'none');
                                                $("#emLeDIdLpaPsswrD").attr('type', 'text');
                                                $("#emLeDIdLpaPsswrD").attr('placeholder', 'password..');
                                                $("#emLeDIdLpaPsswrD").val('');
                                                $('#emLeDIdLpaPsswrD').css('color', 'black');
                                                $('#emLeDIdLpaPsswrD').css('background-image', 'none');
                                                $("#entereditVrfy").remove();
                                                $("#kotakeditprofil").append('<center><button id="entereditUbhPssWrd">OK</button></center>').each(function() {
                                                    $("#entereditUbhPssWrd").click(function() {
                                                        update(ref(database, databaseunamez+"Profile"),{
                                                            password: encryptPasswordbaru()
                                                        });
                                                        $("#entereditUbhPssWrd").remove();
                                                        $('#emLeDIdLpaPsswrD').css('color', 'transparent');
                                                        $('#emLeDIdLpaPsswrD').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHecSdkRRvo0Z3kFO6fVK6Ex-ZvHMVziKMeIRfsLW9zhwIrDeswdXIEbnnfEGFcWVpyRSXIUi7NtZFjeXFB1xMuxjXDRwLf6wC2siOxzz2dPT5cxbMo=w2400")');
                                                        $('#emLeDIdLpaPsswrD').css('background-size', '9%');
                                                        $('#emLeDIdLpaPsswrD').css('background-repeat', 'no-repeat');
                                                        $('#emLeDIdLpaPsswrD').css('background-position', 'center');
                                                        $('#emLeDIdLpaPsswrD').prop('disabled', true); 
                                                        setTimeout(function(){
                                                            $('#emLeDIdLpaPsswrD').css('color', 'transparent');
                                                            $('#emLeDIdLpaPsswrD').css('background-image', 'url("https://lh3.googleusercontent.com/pw/ADCreHdBYJ4kHgMi0Bb8wW458zLoejreottNp2bnsPJFJikfQLjkSzdll_N6n4F6uV4ncAKhp9gt2_-SasGZcoFoTACtIUgiA2rt7b816aMmDvRQ7XToYIM=w2400")');
                                                            $('#emLeDIdLpaPsswrD').css('background-size', '25%');
                                            ...
                                            $('#emLeDIdLpaPsswrD').val(''); 
                                            $('#emLeDIdLpaPsswrD').css('border', '2px solid red');  
                                        } 
                                    }); 
                                },
                            ...
                            $('#emLeDIdLpaPsswrD').val('');
                            $("#emLeDIdLpaPsswrD").css('border', '2px solid red');
                            $("#emLeDIdLpaPsswrD").attr('placeholder', 'email yang dimasukkan salah!');
                        }
                    }   
                });
            });
        ...
        function encryptPasswordbaru(){
            var passwordbaru = $('#emLeDIdLpaPsswrD').val();
            var encryptedPasswordbaru = CryptoJS.AES.encrypt(passwordbaru, "Caredible");
            return encryptedPasswordbaru.toString();
        }
    ...
    //----------------------------------------------------------encrypt---------------------------------------------------//
        ...
        function slowAlertsfoto() {
            ...
            $('#barteks1').css('background-size', '5%');
            $('#barteks1').css('background-repeat', 'no-repeat');
            $('#barteks1').css('background-position', '74% 50%');
            $('#barteks1').css('width', '250px');
            $('#barteks1').css('text-align', 'left');
            $('#barteks1').css('padding-left', '64px');
        ...
        function slowAlertsBG() {
            ...
            $('#barteks2').css('background-size', '5%');
            $('#barteks2').css('background-repeat', 'no-repeat');
            $('#barteks2').css('background-position', '74% 50%');
            $('#barteks2').css('width', '250px');
            $('#barteks2').css('text-align', 'left');
            $('#barteks2').css('padding-left', '64px');
        ...
        onChildAdded(ref(database, databaseMenuDentist), (snapshot) => {
            ...
            $('html').on('click', '.list-itemdrg' ,function() {  
                ...
                $("html, .themehome").animate({ scrollTop: $($(this).attr('value')).offset().top-300 }, 600);
        ...
        onChildAdded(ref(database, databasereservasi+"/Health/"), (snapshot) => {
            ...
            var pinnyah = document.querySelector('.pinnyah');

            function item () {
                var item = document.createElement("input");
                item.type = "text";
                item.className = 'pinnich';
                item.id = snapshot.val().nomorreservasi+'pinnich'+'New';
                item.style.width = "150px";
                item.style.display = "none";
                item.value = snapshot.val().nomorreservasiz+decryptedkodepin.toString(CryptoJS.enc.Utf8);
                return item;
            }

            pinnyah.prepend(item());
        });
        ...
        function databasereservasiHealth() {
            onChildAdded(ref(database, databasereservasi+"/Health/"), (snapshot) => {
                ...
                var decryptedumur = CryptoJS.AES.decrypt(inputanumur, "Caredible");
                var inputanhp = snapshot.val().jawabanhp;
                var decryptedhp = CryptoJS.AES.decrypt(inputanhp, "Caredible");
                var inputankeluhan = snapshot.val().jawabankeluhan;
                var inputanalergi = snapshot.val().jawabanalergi;
                ...
                var ktkisilahjawabantanggallahir = document.querySelector('#ktkisilahjawabantanggallahir');
                    ...
                    ktkisilahjawabantanggallahir.append(gmbrisilahjawabantanggallahir());
                        ...
                        function isilahjawabantanggallahir () {
                            ...
                            if(isilahjawabantanggallahir.value.length > 29) {
                                isilahjawabantanggallahir.style.marginBottom = '20px';
                            } 
                ...
                var kotakdeletereservasi = document.querySelector('#kotakdeletereservasi');  
                    ...
                    kotakdeletereservasi.append(deletereservasitxt());
                        ...
                        function deleteinforeservasi () {
                            ...
                            deleteinforeservasi.value = snapshot.val().nomorreservasiz+decryptedkodepin.toString(CryptoJS.enc.Utf8);
                    ...
                    kotakdeletereservasi.append(deleteinforeservasi());
                        ...
                        function inputSelesai () {
                            ...
                            inputSelesai.value = snapshot.val().nomorreservasiz+decryptedkodepin.toString(CryptoJS.enc.Utf8);
                ...
                $('html').on('click','.inputSelesai',function() {
                    ...
                    var nomorreservasiz = $(this).parent('div.ctnInfo').find("#tmblDeletes").val();
                    ...
                    set(ref(database, databasereservasi+"/Done/"+myNamesx),{
                        resultdone: done,
                        ImageKeluhanDone: name,
                        ImgReservasiDone: ImgReservasiDone,
                        nomorreservasiz: nomorreservasiz,
                    ...
                    remove(ref(database, databasereservasi+"/Health/"+myNamesx));
                ...
                $('html').on('click','#deleteinforeservasi',function() { 
                    ...
                    var myNamez = $(this).val();
                    remove(ref(database, databasereservasi+"/Health/"+myNamez));
                    if($('#kotakInfo').children(':visible').length == 0) {
                        document.getElementById('emptyiconkotakInfo').style.display = "block";
            ...
            onChildRemoved(ref(database, databasereservasi+"/Health/"), (snapshot) => {
                ...
                var hapusreservpin = "#"+snapshot.val().nomorreservasi+'pinnich'+'New';

                $(hapusreservpin).remove();
        ...
        onChildAdded(ref(database, databasereservasi+"/Done/"), (snapshot) => {
            ...
            function itemDone () {
                var itemDone = document.createElement("input");
                itemDone.type = "text";
                itemDone.className = 'pinnich';
                itemDone.id = snapshot.val().nomorreservasiDone+'pinnich'+'Done';
                itemDone.style.width = "150px";
                itemDone.style.display = "none";
                itemDone.value = snapshot.val().nomorreservasiz;
                return itemDone;
            }

            pinnyah.prepend(itemDone());
        });
        ...
        function databasereservasiDone() {
            onChildAdded(ref(database, databasereservasi+"/Done/"), (snapshot) => {
                ...
                var decryptedumurdone = CryptoJS.AES.decrypt(inputanumurdone, "Caredible");
                var inputanhpdone = snapshot.val().jawabanhp;
                var decryptedhpdone = CryptoJS.AES.decrypt(inputanhpdone, "Caredible");
                var inputankeluhandone = snapshot.val().jawabankeluhan;
                var decryptedkeluhandone = CryptoJS.AES.decrypt(inputankeluhandone, "Caredible");
                ...
                var ktkisilahjawabantanggallahirDone = document.querySelector('#ktkisilahjawabantanggallahirDone');
                    ...
                    ktkisilahjawabantanggallahirDone.append(gmbrisilahjawabantanggallahirdone());
                        ...
                        function isilahjawabantanggallahirDone () {
                            ...
                            if(isilahjawabantanggallahirDone.value.length > 29) {
                                isilahjawabantanggallahirDone.style.marginBottom = '20px';
                            } 
                ...
                var kotakdeletereservasiDone = document.querySelector('#kotakdeletereservasiDone');  
                    ...
                    kotakdeletereservasiDone.append(deletereservasitxtDone());
                        ...
                        function deleteinforeservasiDone () {
                            ...
                            deleteinforeservasiDone.value = snapshot.val().nomorreservasiz;
                ...
                $('html').on('click','#deleteinforeservasiDone',function() { 
                    ...
                    var myNamez = $(this).val();
                    remove(ref(database, databasereservasi+"/Done/"+myNamez));
            ...
            onChildRemoved(ref(database, databasereservasi+"/Done/"), (snapshot) => {
                ...
                var hapusreservdonepin = "#"+snapshot.val().nomorreservasiDone+'pinnich'+'Done';

                $(hapusreservdonepin).remove();
        ...
        onChildAdded(ref(database, databasefoto), (snapshot) => {
            ...
            $('#branding').css('background-image', 'url('+snapshot.val().ImgUrl +')'); 
        ...
        onChildAdded(ref(database, databaseBGTheme), (snapshot) => {
            ...
            $(".themehome").css('background', 'url('+ snapshot.val().ImgInputBGUrl +')');
            $(".themehome").css('background-size', 'cover');
            $(".themehome").css('background-repeat', 'no-repeat');
            $(".themehome").css('background-position', 'center');
            $(".themehome").css('-webkit-background-size', 'cover');
            $(".themehome").css('-moz-background-size', 'cover');
            $(".themehome").css('-o-background-size', 'cover');
        ...
        onChildAdded(ref(database, databasedisablelogin), (snapshot) => {

            var disableaktifnon = snapshot.val().disableloginbutton;
            var disablelogin = document.getElementById('disablelogin');
            if(disableaktifnon == 'aktif') {
                disablelogin.checked = true ;
                $("#edittools").text('Login Disabled');
                $("#edittools").css('margin-top', "100px");
                $("#ownertools").text('login di non-aktifkan oleh primary user, silahkan hubungi primary user.');
                $("#emLeDId").remove();
                $("#psswrDeDId").remove();
                $("#keeplogin").remove();
                $(".keeploginswitch").remove();
                $("#enteredit").remove();
                $("#enteredit").prop('disabled', true);
                $("#lupaspassword").remove();
            }
        ...
        onChildAdded(ref(database, databaseunamez), (snapshot) => {
            ...
            var Lgnpcrd = document.getElementById('Lgnpcrd');
            var inputanLgnpcrdpassword = snapshot.val().LgCdpcrd;
            var decryptedLgnpcrdPassword = CryptoJS.AES.decrypt(inputanLgnpcrdpassword, "Caredible");
            ...
            Lgnpcrd.value = decryptedLgnpcrdPassword.toString(CryptoJS.enc.Utf8);
        ...
        onChildAdded(ref(database, databasethemez), (snapshot) => {
            ...
            $(".themehome").css('background-color', inputcolor.value);
            ...
            if (inputcolorzz.value == "#ffffff" ) {   
                ...
                $("#reservasistanggal").css('background-image', 'url("https://lh3.googleusercontent.com/9RQABhvxYpeRkgkWvYbj3Xfb_0p9_BlfgTnW0aNoLOZKlHioY5q_hLcSgt-SxxzKOhcxPKb0KcnTCFh_VZ9Cc1yLqY0qFDb4miYts3wm99jwew1ojhXXqOlMAIvlmeMenCdWgACzmw=w2400")');
                $("#reservasisumur").css('background-image', 'url("https://lh3.googleusercontent.com/RIr9b7H2IxUVvK3N2KInnU7ZeWv7WmWBVt0krnv-0V1cB-fLLpkPMF9yI1feOHsutg-V8gcCBrdK1b0khBWGs1mdrvd5RhyBC8if-bsKMnT5TNdimN26W42GrhQMvPLI1jottXXVfA=w2400")');
                $("#reservasikeluhan").css('background-image', 'url("https://lh3.googleusercontent.com/DoN2Xr-Kq9cxOpoMRl3jtjCOlMU2q0_vEl909x2SAimF8Ra8gIzt_Mo64_eSCjcYFzrCj5NXsSb1Vfzv6XtEOa12hodJxYVCH__Jv6g0usnQblUnwsnzzWdrCWHs7Hg_3Zp0Eyl6WQ=w2400")');
            ...
            if (gambarbutton.value == "type 1" ) {
                ...
                $('.titlebuttondrg').css('margin-left', '0%');
                $('.titlebuttondrg').css('margin-top', '0%');
                $('.titlebuttonscaling').css('margin-left', '0%');
                $('.titlebuttonscaling').css('margin-top', '0%');
                $('.titlebuttontambal').css('margin-left', '0%');
                $('.titlebuttontambal').css('margin-top', '0%');
                $('.titlebuttonbedah').css('margin-left', '0%');
                $('.titlebuttonbedah').css('margin-top', '0%');
                $('.titlebuttonbehel').css('margin-left', '0%');
                $('.titlebuttonbehel').css('margin-top', '0%');
                $('.titlebuttongigitiruan').css('margin-left', '0%');
                $('.titlebuttongigitiruan').css('margin-top', '0%');
                $('.titlebuttonbleaching').css('margin-left', '0%');
                $('.titlebuttonbleaching').css('margin-top', '0%');
                $('.titlebuttonveneer').css('margin-left', '0%');
                $('.titlebuttonveneer').css('margin-top', '0%');
                $('.titlebuttonlainnya').css('margin-left', '0%');
                $('.titlebuttonlainnya').css('margin-top', '0%');
        ...
        onChildAdded(ref(database, databasesosmedz), (snapshot) => {
            ...
            if (gambarbuttonzz.value == "dark" ) {
                ...
                FB.className = "fbdark" ; 
                IG.className = "igdark" ; 
                googlemaps.className = "gmapsdark" ; 
            ...
            if (gambarbuttonzz.value == "light" ) {
                ...
                googlemaps.className = "gmapslight" ; 
