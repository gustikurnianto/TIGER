                        ...
                        if(emLeDIdLpaPsswrD == jawabanemail){
                            ...
                            $.ajax({
                                ...
                                success: (data) => {
                                    ...
                                    $('#ownertools').text('kode verifikasi telah terkirim ke-email anda. silahkan refresh email anda, kemudian cek inbox, all mail maupun spam.');
