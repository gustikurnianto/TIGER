...
$('#showall').click(function(){
    ...
    $('.borderlistz').css('height','98.5px');
    $('.borderlistz').css('width','98.5px');
    $('.borderlistz').css('border-radius','0px');
    $('.borderlistz').css('outline','1px solid white');
    $('.list-item').css('height','95px');
    $('.list-item').css('width','95px');
    $('.list-item').css('margin-bottom','0px');
    $('.list-item').css('margin-left','1px');
    $('.list-item').css('border-radius','0px');
    $('.list-item').css('border','none');
    $('.list-item').css('padding-top','0px');
    $('.scroll').css('padding-left','0px');
...
$('#showall2').click(function(){
    ...
    $('.list-item').css('height','80px');
    $('.list-item').css('width','80px');
    $('.list-item').css('margin-bottom','0px');
