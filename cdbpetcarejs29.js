  ...
  //-----------------------------------------------------------------------------------//
    ...
    //----------------------------------------------------------encrypt---------------------------------------------------//
        ...
        onChildAdded(ref(database, databasehighlight), (snapshot) => {
            ...
            $(".containerzhighlightz").prepend('<div class="deletehighlightz" id="deletehighlightz"><input type="text" id="linkimg" value="'+ snapshot.val().ImgHighlight +'" style="display:none"><img class="borderlistzz" id="borderlistzz" src="'+ snapshot.val().ImgHighlight +'"/><button type="button" id="tmblPin" value="' + snapshot.val().nomorz +"Highlight" +'" style="display:'+ snapshot.val().tmblpin +'">tmblPin</button><button type="button" class="tmblUnpin" id="tmblUnpin" value="' + snapshot.val().nomorz +"Highlight" +'" style="display:'+ snapshot.val().tmblunpin +'">tmblUnpin</button><button type="button" id="tmblDelete">tmblDelete</button><div id="overlaydelete"></div><div class="kotakdeletercrd" id="kotakdeletercrd"><div class="canceldeletercrd"></div><div id="deletercrd">Delete Highlight</div><div id="deletercrdtxt">are you sure to delete this highlight?</div><input type="text" value="' + snapshot.val().nomorz +"Highlight" +'" id="deleteinfo" readonly></div></div>');
