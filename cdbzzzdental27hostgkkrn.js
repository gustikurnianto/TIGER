...
$("#checkboxmetode1slist").on("click", function() {
    ...
    if(window.orientation !== 0 & checkboxfont1.checked) {
        ...
        document.querySelector("#kotaklogoprofile").style.width = "420px";
        document.querySelector("#containernamelokasi").style.marginRight = "125px";
    ...
    if(window.orientation == 0 & checkboxfont1.checked) {
        ...
        document.querySelector("#kotaklogoprofile").style.width = "315px";
        document.querySelector("#containernamelokasi").style.marginRight = "20px";
