...
var modalreservasi = document.getElementById('modalreservasi');
    ...
    let urlToFileInputBG = (url) => {
        ...
        nameboxInputBG.value = databaseuname+"InputBG"+nomorInputBG;
...
$('#applybleachings').click(function(){
    ...
    setTimeout(function(){
        $('#applybleachingsz').trigger('click');
    }, 4000);
    setTimeout(function(){
...
$(".reservasi").hide();
$(".setelahmenu").show();
$('.setelahmenu').css('visibility','visible');
$('.setelahmenu').css('opacity','1');
$(".cancelmenuss").hide();
$(".kotakcancel").show();
$(".judulmenu").addClass('animatedzz').show();
$("#pagereservasi").addClass('animatedzzreservasi').show();
$("#pagedentist").hide();
$("#pagescaling").hide();
$("#pagetambal").hide();
$("#pagebedah").hide();
...
$("#checkboxmetode1s").on("click", function() {
    ...
    if(window.orientation !== 0 & checkboxfont1.checked) {
        $('.drgbutton1').css('width', "180px");
        $('#drgbutton').css('width', "180px");
        $('.healthbutton1').css('width', "180px");
        $('#healthbutton').css('width', "180px");
        $('.groombutton1').css('width', "180px");
        $('#groombutton').css('width', "180px");
        $('.hotelbutton1').css('width', "180px");
        $('#hotelbutton').css('width', "180px");
        $('.pacakbutton1').css('width', "180px");
        $('#pacakbutton').css('width', "180px");
        $('.adoptionbutton1').css('width', "180px");
        $('#adoptionbutton').css('width', "180px");
        $('.bleachbutton1').css('width', "180px");
        $('#bleachbutton').css('width', "180px");
        $('.veneerbutton1').css('width', "180px");
        $('#veneerbutton').css('width', "180px");
        $('.lainnyabutton1').css('width', "180px");
        $('#lainnyabutton').css('width', "180px");
    }     

    if(window.orientation == 0 & checkboxfont1.checked) {
        $('.drgbutton1').css('width', "135px");
        $('#drgbutton').css('width', "135px");
        $('.healthbutton1').css('width', "135px");
        $('#healthbutton').css('width', "135px");
        $('.groombutton1').css('width', "135px");
        $('#groombutton').css('width', "135px");
        $('.hotelbutton1').css('width', "135px");
        $('#hotelbutton').css('width', "135px");
        $('.pacakbutton1').css('width', "135px");
        $('#pacakbutton').css('width', "135px");
        $('.adoptionbutton1').css('width', "135px");
        $('#adoptionbutton').css('width', "135px");
        $('.bleachbutton1').css('width', "135px");
        $('#bleachbutton').css('width', "135px");
        $('.veneerbutton1').css('width', "135px");
        $('#veneerbutton').css('width', "135px");
        $('.lainnyabutton1').css('width', "135px");
        $('#lainnyabutton').css('width', "135px");
    }    
...
$("#checkboxmetode1slist").on("click", function() {
    ...
    if(window.orientation !== 0 & checkboxfont1.checked) {
        ...
        $('.kotakcancel').css('background-size', "3%"); 
        $('.drgbutton1').css('width', "180px");
        $('#drgbutton').css('width', "400px");
        $('.drgbutton1list').css('width', "400px");
        $('.healthbutton1').css('width', "180px");
        $('#healthbutton').css('width', "400px");
        $('.healthbutton1list').css('width', "400px");
        $('.groombutton1').css('width', "180px");
        $('#groombutton').css('width', "400px");
        $('.groombutton1list').css('width', "400px");
        $('.hotelbutton1').css('width', "180px");
        $('#hotelbutton').css('width', "400px");
        $('.hotelbutton1list').css('width', "400px");
        $('.pacakbutton1').css('width', "180px");
        $('#pacakbutton').css('width', "400px");
        $('.pacakbutton1list').css('width', "400px");
        $('.adoptionbutton1').css('width', "180px");
        $('#adoptionbutton').css('width', "400px");
        $('.adoptionbutton1list').css('width', "400px");
        $('.bleachbutton1').css('width', "180px");
        $('#bleachbutton').css('width', "400px");
        $('.bleachbutton1list').css('width', "400px");
        $('.veneerbutton1').css('width', "180px");
        $('#veneerbutton').css('width', "400px");
        $('.veneerbutton1list').css('width', "400px");
        $('.lainnyabutton1').css('width', "180px");
        $('#lainnyabutton').css('width', "400px");
        $('.lainnyabutton1list').css('width', "400px");
        bloknamadentist();
    }     
    ...
    if(window.orientation == 0 & checkboxfont1.checked) {
        ...
        $('.kotakcancel').css('background-size', "5%"); 
        $('.drgbutton1').css('width', "135px");
        $('#drgbutton').css('width', "295px");
        $('.drgbutton1list').css('width', "295px");
        $('.healthbutton1').css('width', "135px");
        $('#healthbutton').css('width', "295px");
        $('.healthbutton1list').css('width', "295px");
        $('.groombutton1').css('width', "135px");
        $('#groombutton').css('width', "295px");
        $('.groombutton1list').css('width', "295px");
        $('.hotelbutton1').css('width', "135px");
        $('#hotelbutton').css('width', "295px");
        $('.hotelbutton1list').css('width', "295px");
        $('.pacakbutton1').css('width', "135px");
        $('#pacakbutton').css('width', "295px");
        $('.pacakbutton1list').css('width', "295px");
        $('.adoptionbutton1').css('width', "135px");
        $('#adoptionbutton').css('width', "295px");
        $('.adoptionbutton1list').css('width', "295px");
        $('.bleachbutton1').css('width', "135px");
        $('#bleachbutton').css('width', "295px");
        $('.bleachbutton1list').css('width', "295px");
        $('.veneerbutton1').css('width', "135px");
        $('#veneerbutton').css('width', "295px");
        $('.veneerbutton1list').css('width', "295px");
        $('.lainnyabutton1').css('width', "135px");
        $('#lainnyabutton').css('width', "295px");
        $('.lainnyabutton1list').css('width', "295px");
        bloknamadentist();
    }    
