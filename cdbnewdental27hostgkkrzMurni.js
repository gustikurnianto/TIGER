...
const backseting = document.querySelector('.backseting');
const ktkinputmenuz = document.querySelectorAll('.ktkinputmenuz');
const ktkinputmenu = document.getElementById('ktkinputmenu');
const dentistseting = document.getElementById('dentistseting');
const ktkdentist = document.getElementById('ktkdentist');
const scalingseting = document.getElementById('scalingseting');
const ktkscaling = document.getElementById('ktkscaling');
const tambalseting = document.getElementById('tambalseting');
const ktktambal = document.getElementById('ktktambal');
const bedahseting = document.getElementById('bedahseting');
const ktkbedah = document.getElementById('ktkbedah');
const behelseting = document.getElementById('behelseting');
const ktkbehel = document.getElementById('ktkbehel');
const giturseting = document.getElementById('giturseting');
const ktkgitur = document.getElementById('ktkgitur');
const bleachingseting = document.getElementById('bleachingseting');
const ktkbleaching = document.getElementById('ktkbleaching');
const veneerseting = document.getElementById('veneerseting');
const ktkveneer = document.getElementById('ktkveneer');
const lainnyaseting = document.getElementById('lainnyaseting');
const ktklainnya = document.getElementById('ktklainnya');
...
// Mengambil elemen-elemen yang akan digunakan
const healthtools = document.getElementById('healthtools');
const healthtoolsblack = document.getElementById('healthtoolsblack');
const editthetools = document.getElementById('editthetools');
const editthetoolsblack = document.getElementById('editthetoolsblack');
const reservationstools = document.getElementById('reservationstools');
const reservationstoolsblack = document.getElementById('reservationstoolsblack');
const orderreservasitools = document.getElementById('orderreservasitools');
const orderreservasitoolsblack = document.getElementById('orderreservasitoolsblack');
const pacaktools = document.getElementById('pacaktools');
const pacaktoolsblack = document.getElementById('pacaktoolsblack');
const adopttools = document.getElementById('adopttools');
const adopttoolsblack = document.getElementById('adopttoolsblack');
const groupusername = document.querySelectorAll('.groupusername');
const groupeditreservasi = document.getElementById('groupeditreservasi');
const grouporderreservasi = document.getElementById('grouporderreservasi');
const grouphighlightz = document.getElementById('grouphighlightz');
const settingz = document.getElementById('settingz');
const highlightz = document.getElementById('highlightz');
const inputhighlightz = document.getElementById('inputhighlightz');
const groupeditmenu = document.getElementById('groupeditmenu');
const clearzz = document.getElementById('clearz');
const searchnew = document.getElementById('searchnew');
const buttontodaynew = document.getElementById('buttontodaynew');
const searchdone = document.getElementById('searchdone');
const newanddone = document.getElementById('newanddone');
const htmlpdf = document.getElementById('htmlpdf');
...
const analitiktools = document.getElementById('analitiktools');
const analitiktoolsblack = document.getElementById('analitiktoolsblack');
const containerAnalitik = document.getElementById('containerAnalitik');
const canvasBar = document.getElementById('canvasBar');
const canvasDoughnut = document.getElementById('canvasDoughnut');
const kotakInfo = document.getElementById('kotakInfo');
const kotakInfoDone = document.getElementById('kotakInfoDone');
const newtools = document.getElementById('newtools');
const newtoolsblack = document.getElementById('newtoolsblack');
const donetools = document.getElementById('donetools');
const donetoolsblack = document.getElementById('donetoolsblack');
const tambahanorderreservasi = document.getElementById('tambahanorderreservasi');
const emptyiconkotakInfo = document.getElementById('emptyiconkotakInfo');
...
orderreservasitools.addEventListener('click', function () {
    ...
    // Fungsi isilah
    function isilah() {
        const text = document.querySelectorAll('.isilah');
...
const emptyiconkotakInfoDone = document.getElementById('emptyiconkotakInfoDone');
...
donetools.addEventListener('click', function () {
    ...
    // Fungsi isilahDone
    function isilahDone() {
        const textDone = document.querySelectorAll('.isilahDone');
...
const clearz = document.getElementsByClassName('clear');
const kosong = document.getElementsByClassName('kosong');
...
analitiktools.addEventListener('click', function () {
    ...
    const satu = document.querySelector('.titlebuttonscaling').textContent;
    const dua = document.querySelector('.titlebuttontambal').textContent;
    const tiga = document.querySelector('.titlebuttonbedah').textContent;
    const empat = document.querySelector('.titlebuttonbehel').textContent;
    const lima = document.querySelector('.titlebuttongigitiruan').textContent;
    const enam = document.querySelector('.titlebuttonbleaching').textContent;
    const tujuh = document.querySelector('.titlebuttonveneer').textContent;
    const delapan = document.querySelector('.titlebuttonlainnya').textContent;
    ...
    const reservasiElements = document.querySelectorAll('.judulreservasi, .judulreservasiDone');

    reservasiElements.forEach(function (element) {
        const reservasi = element.textContent;
...
const reservasi = document.querySelectorAll('.reservasi');
const setelahmenu = document.querySelector('.setelahmenu');
const cancelmenuss = document.querySelectorAll('.cancelmenuss');
const kotakcancel = document.querySelector('.kotakcancel');
const judulmenu = document.querySelector('.judulmenu');
const pagereservasi = document.querySelector('#pagereservasi');
const pages = document.querySelectorAll('.pages');
const yakinform = document.querySelectorAll('.yakinform');
const kirimform = document.querySelectorAll('.kirimform');
const acakkodepin = document.querySelector('#acakkodepin');
...
acakkodepin.addEventListener('click', function () {
    ...
    const charsUpper = "ABCDEFGHIJKLMNOPQRSTUVWXTZ";
    const charsAll = [charsNumber];
    const chars = charsAll.join('');
    ...
    const kodepin = document.getElementById('kodepin');
...
const kodepin = document.getElementById('kodepin');
const kodepinbukti = document.getElementById('kodepinbukti');
...
// Mengambil elemen-elemen yang akan digunakan
const tabel1z = document.getElementById('tabel1z');
const klmpbutton = document.querySelectorAll('.klmpbutton');
const titlebuttondrg = document.querySelector('.titlebuttondrg');
const bloknamadentist = document.querySelectorAll('.bloknamadentist');
...
function handleDrgButtonClick() {
    ...
    const z = titlebuttondrg.innerHTML;
...
const drgbutton = document.getElementById('drgbutton');
drgbutton.addEventListener('click', handleDrgButtonClick);

// Mengambil elemen-elemen yang akan digunakan
const tambahanreservasi = document.querySelectorAll('.tambahanreservasi');
const titlebuttonscaling = document.querySelector('.titlebuttonscaling');
const titlebuttontambal = document.querySelector('.titlebuttontambal');
const titlebuttonbedah = document.querySelector('.titlebuttonbedah');
...
function handleMenuButtonClick(pagesIndex, titleElement) {
    ...
    klmpbutton.forEach(el => el.style.display = 'none');
    const z = titleElement.innerHTML;
    cancelmenuss[0].innerHTML = z;
...
// Mengambil elemen-elemen yang akan digunakan
const titlebuttonbehel = document.querySelector('.titlebuttonbehel');
const titlebuttongigitiruan = document.querySelector('.titlebuttongigitiruan');
const titlebuttonbleaching = document.querySelector('.titlebuttonbleaching');
...
const pacakbutton = document.getElementById('pacakbutton');
...
// Mengambil elemen-elemen yang akan digunakan
const titlebuttonveneer = document.querySelector('.titlebuttonveneer');
const titlebuttonlainnya = document.querySelector('.titlebuttonlainnya');
...
const veneerbutton = document.getElementById('veneerbutton');
...
const lainnyabutton = document.getElementById('lainnyabutton');
...
const inputcolorz = document.getElementById("inputcolorz");
const colorPickerz = document.getElementById("colorPickerz");
const colorPickerzz = document.getElementById("colorPickerzz");
const inputcolorzz = document.getElementById("inputcolorzz");
const drgbg = document.querySelectorAll(".drgbg");
const scalingbg = document.querySelectorAll(".scalingbg");
const tambalbg = document.querySelectorAll(".tambalbg");
const bedahbg = document.querySelectorAll(".bedahbg");
const behelbg = document.querySelectorAll(".behelbg");
const gigitiruanbg = document.querySelectorAll(".gigitiruanbg");
const bleachingbg = document.querySelectorAll(".bleachingbg");
const veneerbg = document.querySelectorAll(".veneerbg");
const lainnyabg = document.querySelectorAll(".lainnyabg");
const infos = document.querySelectorAll(".infos");
const isiform = document.querySelectorAll(".isiform");
const reservasis = document.querySelectorAll(".reservasis");
const titledentist = document.querySelectorAll(".titledentist");
const cekreservasi = document.getElementById("cekreservasi");
const saygreetinginput = document.getElementById("saygreetinginput");
const colorPickerzzz = document.getElementById("colorPickerzzz");
const inputcolorzzz = document.getElementById("inputcolorzzz");
const kalimatsilahkan = document.querySelectorAll(".kalimatsilahkan");

// Event listener untuk "#ubahusername"
ubahusername.addEventListener("input", function() {
    const z = ubahusername.value;
    userNametools.innerHTML = "@" + z;
});

// Event listener untuk "#colorPicker"
colorPicker.addEventListener("input", function() {
    const z = colorPicker.value;
    inputcolor.value = z;
