...
document.querySelector('.reservasi').addEventListener('click', function() {
    ...
    document.querySelector('.kotakcancel').style.display = 'block';
    document.querySelector('.kotakcancel').style.width = '315px';
    document.querySelector('.judulmenu').style.display = 'block';
    document.querySelector('.judulmenu').style.marginTop = '18px';
    document.querySelector('.judulmenu').style.width = '315px';
