  ...
  //-----------------------------------------------------------------------------------//
                        ...
                        if(emLeDIdLpaPsswrD == jawabanemail){
                            ...
                            $.ajax({
                                ...
                                success: (data) => {
                                    ...
                                    $("#kotakeditprofil").append('<center><div id="hitungMundur">03:00</div><button id="entereditVrfy">OK</button></center>');    
                                    var waktuAwal = 180;
                                    ...
                                    $('#entereditVrfy').click(function(){
                                        ...
                                        if (verify.value == code_val) { 
                                            ...
                                            $("#hitungMundur").remove();
                                            $("#entereditVrfy").css('margin-top', '30px');
    ...
    //----------------------------------------------------------encrypt---------------------------------------------------//
        ...
        onChildAdded(ref(database, databasenotif+"/Push/"), (snapshot) => {
            ...
            var decryptednamapasienzz = CryptoJS.AES.decrypt(inputannamapasienzz, "Caredible");
            var ubahusernamekeepzz = document.getElementById('Lgnpcrd').value;
            let keepLoggedIncDbgst100395zz = localStorage.getItem(ubahusernamekeepzz);
            var disablepush = document.getElementById('disablepush');
