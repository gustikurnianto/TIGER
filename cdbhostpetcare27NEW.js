...
$("#checkboxmetode1slist").on("click", function() {
    ...
    if(window.orientation !== 0 & checkboxfont1.checked) {
        ...
        $('#jawabannamapasien').css('width', "296px"); 
        $('#jawabanalamat').css('width', "296px"); 
        $('#jawabantanggallahir').css('width', "296px"); 
        $('#jawabanumurangka').css('width', "200px"); 
        $('#jawabanjeniskelamin').css('width', "296px"); 
        $('#jawabankeluhan').css('width', "296px"); 
        $('#jawabanalergi').css('width', "296px"); 
        $('#jawabanfotokeluhanz').css('width', "271px"); 
        $('#jawabanjadwal').css('width', "296px"); 
        $('.jawabanjams').css('width', "296px"); 
        $('.jawabanjamsdokter').css('width', "286px"); 
        $('#jawabanhp').css('width', "296px"); 
    ...
    if(window.orientation == 0 & checkboxfont1.checked) {
        ...
        $('#jawabannamapasien').css('width', "223px"); 
        $('#jawabanalamat').css('width', "223px"); 
        $('#jawabantanggallahir').css('width', "223px"); 
        $('#jawabanumurangka').css('width', "131px"); 
        $('#jawabanjeniskelamin').css('width', "223px"); 
        $('#jawabankeluhan').css('width', "223px"); 
        $('#jawabanalergi').css('width', "223px"); 
        $('#jawabanfotokeluhanz').css('width', "198px"); 
        $('#jawabanjadwal').css('width', "223px"); 
        $('.jawabanjams').css('width', "223px"); 
        $('.jawabanjamsdokter').css('width', "213px"); 
        $('#jawabanhp').css('width', "223px"); 
