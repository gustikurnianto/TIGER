$("#jawabantanggallahir").on("input", function() {
...
$('.jenispria').click(function(){
    $('#jawabanjeniskelamin').val('jantan');
    $('#jawabanjeniskelaminz').val('jantan');
    $('.overlayjeniskelamin').hide();
    $('#jawabanjeniskelaminz').trigger('click');
});

$('.jeniswanita').click(function(){
    $('#jawabanjeniskelamin').val('betina');
    $('#jawabanjeniskelaminz').val('betina');
    $('.overlayjeniskelamin').hide();
    $('#jawabanjeniskelaminz').trigger('click');
});
